...
```{r, include=FALSE, child = '2_problem_statement.Rmd'}

```

\newpage

```{r, include=FALSE, child = 'CopyOf3_Bayesian_Optimization_Workflow_test.Rmd'}

```

\newpage

```{r, include=FALSE, child = '4_Example_Cases.Rmd'}

```

\newpage

```{r, include=FALSE,child = '5_Field_Scale.Rmd'}
